...
<h1 class="bg-info" align = "center" class="text-warning"><b>BOOK MY BUS</b></h1>
 ...
 <div class="topnav-right">
  ...
  <form action="Banking.html" class="container">
    <h1>Login</h1>

    <label for="username"><font color="gold"><b>UserName</b></font></label>
    <input type="text" placeholder="Enter UserName" name="username" required>

    <label for="password"><font color="gold"><b>Password</b></font></label>
